// src/features/chat/screens/ChatModeScreen.tsx
...
export const ChatModeScreen: React.FC<ChatModeScreenProps> = ({
  userName = 'User',
  onSwitchToKeyboard
}) => {
  ...
  const handleBack = () => {
    if (intentHistory.length > 0) {
      ...
      // Already at main level, could switch back to keyboard mode
      if (onSwitchToKeyboard) {
        onSwitchToKeyboard();
      }
    }
  };
      ...
      <View style={[styles.header, { backgroundColor: theme.colors.brand.primary }]}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerTitleContainer}>
            <Text style={styles.headerTitle}>FamilyKnows Assistant</Text>
            <Text style={styles.headerSubtitle}>Chat Mode</Text>
          </View>
          <TouchableOpacity onPress={onSwitchToKeyboard} style={styles.switchButton}>
